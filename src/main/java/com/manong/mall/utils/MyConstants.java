...
public  class MyConstants {
	...
	public static String PATH_LINK="http://local.hilinli.com/wd_web/m/goods.jhtml";
...
//			System.out.println(path);
			InputStream inputStream = this.getClass().getResourceAsStream("/configs/constants.properties");
