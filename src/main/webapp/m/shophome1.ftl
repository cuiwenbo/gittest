...
<div class="container" id="container">
      <div class="row">	
                <div class=" col-xs-12 inde-top">
                	 <a href="shop.jhtml?id=${shop.id}" class="inde-gua"><img src="${imghost}${shop.pict}" style="width:20px;height:20px;border-radius:10px"/> ${shop.name}</a>
	                 <div style="text-align: right;">
                    	<a href="shop!intresList.jhtml" class="inde-guc" >我的关注</a>
                    </div>
        ...
        <div class="row">	         
                 <div class="col-xs-12 inde-inc">
                   <div class="col-xs-3 inde-incbor">
                    ...
                    <div class="col-xs-3 inde-incbor">
                    	<a href="shop!goodsList.jhtml?sid=${shop.id}&op=new">
                            <div class="inde-count">
                                ${totalnews}
                            </div>
                            <div class="inde-count">
          ...
          <div class="row inde-posc">	         
                 <div class="col-xs-12 " id="shop_list">
                  <#list goods as p>
                   <a href="goods.jhtml?id=${p.id}&op=show">
                   <div class="col-xs-6">
