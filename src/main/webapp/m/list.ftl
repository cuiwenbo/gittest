...
<div class="container">
      <div class="row">	
      	 <div class=" col-xs-12 nlist-top">
			 <a href="shop.jhtml?id=${shop.id}" class="inde-gua"><img src="${imghost}${shop.pict}" style="width:20px;height:20px;border-radius:20px"/> ${shop.name}</a>
			 <a href="goods!visitList.jhtml" class="inde-guc">浏览记录</a>
         </div>
      </div>       
</div>
     ...
     <div class="row">	
         <ul id="myTab" class="col-xs-12 nav nav-tabs nlist-tab">
            <li class=" col-xs-3 <#if op=='all'>active</#if>">
              <a href="shop!goodsList.jhtml?sid=${shop.id}&op=all">
                 	默认
              </a>
            </li>
            <li class=" col-xs-3 <#if op=='hot'>active</#if>">
            	<a href="shop!goodsList.jhtml?sid=${shop.id}&op=hot" >销量</a>
            </li>
            <li class=" col-xs-3 <#if op=='popular'>active</#if>">
            	<a href="shop!goodsList.jhtml?sid=${shop.id}&op=popular" >人气</a>
            </li>
            <li class=" col-xs-3 <#if op=='price'>active</#if>">
            	<a href="shop!goodsList.jhtml?sid=${shop.id}&op=price">价格</a>
            </li>
         </ul>
             	...
             	<div class="container">
                	<div class="row nlist-body">
                    	<div class="col-xs-12" id="shop_list">
                        	 <!--商品-->  
 							<#list goodsList as g> 
                        	 <a href="goods.jhtml?id=${g.id}&op=show">
                        	 <div class="col-xs-6">
  ...
  <div class="container">
     	<div class="row">
     		<div class="col-xs-12 footer">
            	<span class="col-xs-12"><a href="shop.jhtml?id=${shop.id}">店铺首页</a>丨 <a href="javascript:;" onclick="gz_dialog()">关注我们</a> </span>
