...
<title>用户基本信息</title>
<link type="text/css" href="${rc.contextPath}/css/reg.css" rel="stylesheet"/>
...
<div class="userinfo_contain">
	<form name="updateFrm" action="${rc.contextPath}/user/editUserInfo?id=${u.id}" method="post" target="hidefrm">
		...
		<div class="userinfo_pic">
			...
			<#else>
				<img src="${rc.contextPath}/images/head-pic.png" width="70" height="70" id="beiyong_pic"/>
			</#if>
			<div>
				<p>微袋帐号：${u.phone}</p>
				<p>
