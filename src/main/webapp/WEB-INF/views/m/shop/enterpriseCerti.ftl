...
<body>	
	...
	<div>		  
		<a href="shop!get.jhtml?sid=${shop.id}&op=toauth">个人认证（-适合个人认证者，材料简单）</a> | <a href="#">企业认证（-适合企业、公司进行认证）</a>
	</div>
	<div>
	...
	<div style=" display:none;">
	  	<div id="uploadDiv">
			<div class="pop_sub" style="margin:20px;">
	    		<form name="mainfrm" action="upload.jhtml" method="post" enctype="multipart/form-data" target="hidefrm">
