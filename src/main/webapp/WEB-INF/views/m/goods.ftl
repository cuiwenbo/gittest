...
<script src="${rc.contextPath}/m/js/scroll.js"></script>
<style>
...
<div class="container" id="container">
	<div class="row ">
    	 <div class=" col-xs-12 nlist-top">
    	 	<a href="${rc.contextPath}/m/shop/start?id=${shop.id}" class="inde-gua" style="color:#999;float:left">
    	...
    	<div class="with-par1" style="background:#fff;border-color:#e5e5e5;padding:5px 5px 5px 10px;font-size:13px;color:#666">
         ...
         <div class="row">
         		...
         		<div class="with-par1" style="overflow:hidden;background:#fff;margin:10px 0 10px 0;height:40px;line-height:40px;padding:0 10px;border-color:#e5e5e5;font-size:14px">
         			<a href="${rc.contextPath}/m/shop/start?id=${shop.id}" style="color:#333;text-decoration:none"><span style="float:left"><img src="${rc.contextPath}/m/img/shop-pic.png" width="30" style="vertical-align:middle"/>${shop.name}</span></a>
 ...
 <div class="row" >
 	<div class="col-xs-12 nav-zv" style="position:fixed">
	  ...
	  <input type="button" value="立刻购买" style="margin-top:6px" class="bgc1" onclick="window.location='${rc.contextPath}/m/order/buy?op=p1&id=${goods.id}'">
	</div>
      ...
      <div class="modal-content">
         <div class="modal-header" style="font-size:18px">
              ...
              <span class="modal-title" id="myModalLabel">
               1.点击右上角的 <img src="${rc.contextPath}/m/img/gongneng.png" style="width:40px;height:20px;border-radius:2px">
               
            </span>
            <br><br>
            <span class="modal-title" id="myModalLabel">
               2.在弹出的菜单中找到 <img src="${rc.contextPath}/m/img/set.png" style="width:40px;height:40px;border-radius:2px"/> 或者 <img src="${rc.contextPath}/m/img/share.png" style="width:40px;height:40px;border-radius:2px"/> 并点击,然后发送给好友或朋友圈
            </span>
