...
<html>
	<head>
		...
		<title>添加店铺</title>
		<link href="${rc.contextPath}/css/login.css" type="text/css" rel="stylesheet" />
		<script src="${rc.contextPath}/js/jquery-1.8.2.js" type="text/javascript" ></script>
		<script src="${rc.contextPath}/js/catalogC.js" type="text/javascript" ></script>
    	...
    	function afterSave(param) {
    		if(param.result == '0000') {
    			window.location="${rc.contextPath}/shop/toCerPage";
    			return;
    		} else {
...
<div class="main" style="border:none">
	<div class="schedule"><img src="${rc.contextPath}/images/schedule1.png" /></div>
    <div class="main_addstore">
    <form name="mainfrm1" action="${rc.contextPath}/shop/add" method="post" target="hidefrm" onsubmit="return checkInput()">
