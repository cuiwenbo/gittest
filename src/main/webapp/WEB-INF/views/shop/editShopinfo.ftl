...
<html>
	<head>
		...
		<script src="${rc.contextPath}/js/catalog.js" type="text/javascript" ></script>
    ...
    function changePhone() {
    	...
    	function afterSave(param) {
    		if(param.result == '0000') {
    			window.location.href = "${rc.contextPath}/home";
    			return;
    		} else {
		...
		<div class="contain_right" id="contain_right">
			...
			<div class="shopinfo">
				...
				<div class="shopinfo_con">
					<form name="mainfrm1" action="${rc.contextPath}/shop/editInfo" method="post" onsubmit="return checkInput()" target="hidefrm">
							...
							<table class="tab_edit"  border="0" cellpadding="0" cellspacing="0">
								...
								<tr>
							  	...
							  	<tr>
									...
									<td>
										...
										<#else>
											<img src="${rc.contextPath}/images/shop-pic0.png" width="50" height="50" id="detail_pic"  style="vertical-align: middle;"/>
										</#if>
								...
								<tr>
									...
									<td>
										...
										<#else>
											<img src="${rc.contextPath}/images/no_pic.png" width="90" height="40" id="shopBack_pic"  style="vertical-align: middle;"/>
										</#if>
...
function checkName(){
	...
	if(name!='${shop.name}'){
		var url = "${rc.contextPath}/shop/check";
		var par = "name=" + name;
			$.ajax({
				type: "POST",data: par,url: url,dataType: "json",
				success: function(ret){
